...
def restructure_triplets_dataset_3(name, destination_path=None):
...
def restructure_stimuli_dataset_3_july(name, destination_path=None):
    ...
    new_data['index'] = [i for i in range(1, 1 + 3 * len(old_data['phoneitem_id_TGT']))]
...
def restructure_stimuli_dataset_3_august(name, destination_path=None):
    ...
    new_data['index'] = [i for i in range(len(old_data['CORR_ANS'])*3)]
    new_data['#file'] = [*old_data['item_TGT'], *old_data['item_OTH'], *old_data['item_X']]
    new_data['onset'] = [*old_data['onset_TGT'], *old_data['onset_OTH'], *old_data['onset_X']]
    new_data['offset'] = [*old_data['offset_TGT'], *old_data['offset_OTH'], *old_data['offset_X']]
    ...
    new_data['language'] = ['NA' for i in range(len(old_data['CORR_ANS'])*3)]
...
if __name__ == '__main__':
    ...
    NAME_3 = '../pilote_dataset/geomphon-perception-ABX/experiments/pilot_Aug_2018/human_experimental_results.csv'
    DESTINATION_3 = '../Cognitive_ML_datasets/data/pilote_data_aug_2018_human_experimental_results.csv'
    restructure_triplets_dataset_3(NAME_3, DESTINATION_3)

    NAME_3 = '../pilote_dataset/geomphon-perception-ABX/experiments/pilot_july_2018/stimuli/item_meta_information.csv'
    DESTINATION_3 = '../coml_datasets/pilote/pilote_data_july_2018_stimuli.csv'
    restructure_stimuli_dataset_3_july(NAME_3, DESTINATION_3)

    NAME_3 = '../pilote_dataset/geomphon-perception-ABX/experiments/pilot_Aug_2018/stimuli/item_meta_information.csv'
    DESTINATION_3 = '../Cognitive_ML_datasets/data/pilote_data_aug_2018_stimuli.csv'
    restructure_stimuli_dataset_3_august(NAME_3, DESTINATION_3)

    # DESTINATION_3 = '../pilote_dataset/geomphon-perception-ABX/experiments/pilot_Aug_2018/non_filtered_stimuli_labels.csv'
    # restructure_stimuli_csv_dataset_3(NAME_3, DESTINATION_3)
